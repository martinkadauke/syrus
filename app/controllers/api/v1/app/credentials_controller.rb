  ...
  module V1
    module App
      class CredentialsController < BaseController
        ...
        #
        # If the pasted value is already a long-lived token (sk-ant-* prefix,
        # as generated by `claude setup-token`), it is saved directly without
        ...
        def claude_oauth_exchange
          ...
          if ClaudeOauth.looks_like_token?(pasted)
            ...
            return render json: { credential_test: probe.as_json, message: probe.message }
          end
