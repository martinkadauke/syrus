  ...
  class << self
    ...
    def chat_entries
      [
        ...
        chat(SyrusChatMcp::ResetWorkspaceTool, feature_flag: :coding_mode, required_roles: [ AgentRole::CHAT_CODING ], mutation: true),
        ...
        chat(SyrusChatMcp::AdminGithubAppInstallationDiagnosticTool, admin_only: true),
        chat(SyrusChatMcp::ForceFailJobTool, admin_only: true, mutation: true),
        chat(SyrusChatMcp::ReconcileJobStateTool, admin_only: true, mutation: true),
        chat(SyrusChatMcp::ForceStateTransitionTool, admin_only: true, mutation: true),
        chat(SyrusChatMcp::CancelStaleWorkTool, admin_only: true, mutation: true),
        chat(SyrusChatMcp::ReenqueueWorkTool, admin_only: true, mutation: true),
        chat(SyrusChatMcp::ForceRebaseTool, admin_only: true, mutation: true),
        chat(SyrusChatMcp::RestackEpicTool, admin_only: true, mutation: true),
        chat(SyrusChatMcp::ForceLandingRecheckTool, admin_only: true, mutation: true),
        chat(SyrusChatMcp::ManualAgenticRunTool, admin_only: true, mutation: true),
        chat(SyrusChatMcp::AdoptCurrentPrHeadTool, admin_only: true, mutation: true),
        chat(SyrusChatMcp::ReplacePrBranchWithWorkflowOutputTool, admin_only: true, mutation: true),
        chat(SyrusChatMcp::RetryFromCurrentPrBranchTool, admin_only: true, mutation: true),
        chat(SyrusChatMcp::RefreshPrChecksTool, admin_only: true),
        chat(SyrusChatMcp::RerunCiRepairTool, admin_only: true, mutation: true),
        chat(SyrusChatMcp::MarkCiRepairNoopTool, admin_only: true, mutation: true),
        chat(SyrusChatMcp::OverrideLandingBlockerOnceTool, admin_only: true, mutation: true),
        chat(SyrusChatMcp::WakeLandingQueueTool, admin_only: true, mutation: true),
        chat(SyrusChatMcp::InspectProviderCircuitTool, admin_only: true),
        chat(SyrusChatMcp::RepairProviderCircuitEvidenceTool, admin_only: true, mutation: true),
        chat(SyrusChatMcp::ClearProviderCircuitTool, admin_only: true, mutation: true),
        chat(SyrusChatMcp::WakeProviderAdmissionTool, admin_only: true, mutation: true),
    ...
    def workflow_entries
      ...
      [
        ...
        workflow(SyrusMcp::SubmitJobMetadataTool, capability: :submit_job_metadata, required_roles: [
          AgentRole::WORKFLOW_SUMMARY_TEST_PLAN,
          AgentRole::WORKFLOW_MANUAL
        ], mutation: true),
