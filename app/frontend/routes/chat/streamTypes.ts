...
import type { ChatPendingAction, ChatRenderItem } from "../../api/chats"
...
export type ChatStreamItem = ChatRenderItem | ChatPendingActionStreamItem | ChatTimestampItem | ChatDayDividerItem
