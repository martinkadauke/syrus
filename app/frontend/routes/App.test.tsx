...
describe("App", () => {
  ...
  it("renders the app-shell dashboard route from the app dashboard API", async () => {
    ...
    expect(subjectNav.closest("header")).toBe(dashboardHeader)
  ...
  it("renders dashboard smart folder visibility groups and badges", async () => {
    ...
    try {
      ...
      expect(within(dashboardSections).getByRole("link", { name: "Jobs" })).toHaveClass("bg-blue-50", "text-blue-700", "dark:bg-blue-900/30", "dark:text-blue-200")
