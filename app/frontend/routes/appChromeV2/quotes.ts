// Publilius Syrus maxims shown in the app-chrome footer, extracted from
// AppChromeV2.tsx to keep the ~260-line data table out of the component file.

export const PUBLILIUS_SYRUS_QUOTES: { latin: string; english: string }[] = [
