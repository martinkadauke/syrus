// Unified-diff parsing + rendering helpers extracted from JobDetail.tsx.
//
// Parse a unified diff string into typed lines and the Tailwind class helpers
// for each line kind (row/gutter/marker) plus the coverage border. Pure over
// the diff line/annotation types; lifting the types here lets the AgentDiff
// component and its callers move out of the 3k-line JobDetail.tsx.
