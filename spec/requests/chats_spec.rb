...
RSpec.describe "Chats", type: :request do
  ...
  describe "GET /chats/:id" do
    ...
    it "does not render manual proposal buttons or modal forms in the composer" do
      ...
      expect(response.body).not_to include("chat_session_#{chat.id}_epic_proposal_dialog")
      expect(response.body).not_to include("chat_session_#{chat.id}_job_proposal_dialog")
    end
